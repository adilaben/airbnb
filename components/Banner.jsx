...
const Banner = () => {
  return (
    <div className="relative top-0 h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[660px] ">
      ...
      <div className="absolute top-[20%] sm:top-[35%] lg:top-[40%]   w-full text-center">
        <p className="mb-4 text-4xl shadow-md font-extrabold leading-none md:text-5xl lg:text-6xl text-white ">
